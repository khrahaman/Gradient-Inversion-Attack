...
**A quick brief on Federated Learning (FL):** https://github.com/khrahaman/Federated_Learning.git

**Examples of Gradient Inversion Attack (in FL):**

![Reconstruction of client's local data-points from only gradient value](images/reconstruction.png)


![Reconstruction of client's local data-points from only gradient value](images/reconstruction_from_aggregated_gradient_01.png)


![Reconstruction of client's local data-points from only gradient value](images/reconstruction_from_aggregated_gradient_02.png)
